...
import { AlertTriangleIcon, CheckCircleIcon, SparklesIcon } from './common/Icon';
...
const LifestyleOverhaul: React.FC = () => {
    ...
    const { addOverhaulToHistory } = useHistory();

    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        e.preventDefault();
        const query = productList.trim();
        if (!query) {
    ...
    }, [productList, addOverhaulToHistory]);
